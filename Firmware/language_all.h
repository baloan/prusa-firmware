...
extern const char* const MSG_CALIBRATE_FIRST_LANG_TABLE[1];
#define MSG_CALIBRATE_FIRST LANG_TABLE_SELECT_EXPLICIT(MSG_CALIBRATE_FIRST_LANG_TABLE, 0)
...
extern const char* const MSG_FANS_CHECK_OFF_LANG_TABLE[1];
#define MSG_FANS_CHECK_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_FANS_CHECK_OFF_LANG_TABLE, 0)
extern const char* const MSG_FANS_CHECK_ON_LANG_TABLE[1];
#define MSG_FANS_CHECK_ON LANG_TABLE_SELECT_EXPLICIT(MSG_FANS_CHECK_ON_LANG_TABLE, 0)
...
extern const char* const MSG_WAITING_TEMP_PINDA_LANG_TABLE[1];
#define MSG_WAITING_TEMP_PINDA LANG_TABLE_SELECT_EXPLICIT(MSG_WAITING_TEMP_PINDA_LANG_TABLE, 0)
