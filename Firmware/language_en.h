...
#define(length=20, lines=4) MSG_CALIBRATE_FIRST					"Please run XYZ calibration first."
...
#define(length=20, lines=4) MSG_TEMP_CAL_FAILED					"Temperature calibration failed"
